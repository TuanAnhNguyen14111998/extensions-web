// doi tuong pixi_tilemap
var pixi_tilemap;

// phuong thuc khoi tao roi chay luon voi doi so la doi tuong pixi_tilemap, neu co doi tuong pixi_tilemap thi nhan luon, con neu khong thi khoi tao doi tuon pixi_tilemap rong roi truyen vao
(function (pixi_tilemap) {

    // bien CanvasTileRenderer mang gia tri la mot phuong thuc CanvasTileRenderer voi doi so truyen vao la doi tuong renderer: no thiet lap thuoc tinh tileAnim, dontUseTransform renderer tileAnim
    ...
    // dat thuoc tinh cua pixi_tilemap la CanvasRenderer mang phuong thuc la CanvasRenderer
    pixi_tilemap.CanvasTileRenderer = CanvasTileRenderer;
    // them plugin ten la tilemap mang gia tri la phuong thuc CanvasRenderer
    PIXI.CanvasRenderer.registerPlugin('tilemap', CanvasTileRenderer);
})(pixi_tilemap || (pixi_tilemap = {}));

// day la phuong thuc dung de ke thua trong javascript
...
// ---- Nhu vay la pixi_tilemap co phuong thuc CanvasTileRenderer dung de tra ve mot hinh con trong du lieu load len ------


// viec khi bao them mot lan nua doi voi pixi_tilemap khong anh huong den cac gia tri thuoc tinh cua doi tuong pixi_tilemap, pixi_tilemap nay van mang cac gia tri thuoc tinh cua pixi_tilemap o tren
var pixi_tilemap;

// phuong thuc khoi tao roi chay luon voi doi so la doi tuong pixi_tilemap o tren, neu khong co khoi tao doi tuong pixi_tilemap moi
(function (pixi_tilemap) {

    // tao doi tuong Container Tile de nhom cac Tile don vao cung mot nhom, no ke thua doi tuong PIXI.Container
    var CompositeRectTileLayer = (function (_super) {
        // ke thua doi tuong PIXI.Container
        __extends(CompositeRectTileLayer, _super);

        // thiet lap ban dau cho Container Tilemap, no tuong tu nhu Container cua PIXI
        ...
        // xoa cac doi tuong trong Container Tile
        ...
        // Them hinh chu nhat vao container
        ...
        // kiem tra trinh duyet co ho tro webGL hay khong
    ...
    // tra ve container la thuoc tinh cua pixi_tilemap
    pixi_tilemap.CompositeRectTileLayer = CompositeRectTileLayer;

})(pixi_tilemap || (pixi_tilemap = {}));

// xac dinh cac thuoc tinh bo dem cho pixi_tilemap giong nhu texrute Cached
var pixi_tilemap;
(function (pixi_tilemap) {
...
// khoi tao thuoc tinh GraphicsLayer cho pixi_tilemap tuong nhu doi tuong PIXI.Graphics
var pixi_tilemap;
(function (pixi_tilemap) {
    var GraphicsLayer = (function (_super) {

        // ke thua lop PIXI.Graphics
...
(function (pixi_tilemap) {
    var RectTileLayer = (function (_super) {
        ...
        // ve lai hinh khi co su thay doi
        RectTileLayer.prototype.updateTransform = function () {
            _super.prototype.displayObjectUpdateTransform.call(this);
        };

        // khoi tao doi tuong tile hcn
        ...
        // xoa cac noi dung trong tile hcn
